...
Public Class Main
    ...
    Private Sub BOXCONTAINER_SelectedValueChanged(sender As Object, e As System.EventArgs) Handles BOXCONTAINER.SelectedValueChanged
        SwitchContainer()
    End Sub

    Private Sub BOXCONTAINER_TextChanged(sender As Object, e As System.EventArgs) Handles BOXCONTAINER.TextChanged
        SwitchContainer()
    End Sub

    Private Sub OutputCBox_TextChanged(sender As Object, e As System.EventArgs) Handles OutputCBox.TextChanged

    End Sub

    Private Sub OutputCBox_TextUpdate(sender As Object, e As System.EventArgs) Handles OutputCBox.TextUpdate
